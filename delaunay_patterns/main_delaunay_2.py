...
if __name__ == "__main__":
    for i in range(1):
        image_width = 1584  # Adjust the width of the image as needed
        image_height = 396  # Adjust the height of the image as needed
        ...
        thickness = 1
        start_color = convert_hex_to_rgb('#00B4DB')
        end_color = convert_hex_to_rgb('#0083B0')
